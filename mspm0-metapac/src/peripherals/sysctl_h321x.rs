...
pub mod regs {
    ...
    impl Clkstatus {
        ...
        #[doc = "CURHSCLKSEL indicates the current clock source for HSCLK."]
        #[inline(always)]
        pub const fn set_curhsclksel(&mut self, val: bool) {
