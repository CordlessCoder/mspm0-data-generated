...
pub mod regs {
    ...
    impl defmt::Format for Clkstatus {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Clkstatus {{ sysoscfreq: {:?}, hsclkmux: {:?}, lfclkmux: {:?}, hfclkgood: {=bool:?}, syspllgood: {=bool:?}, lfxtgood: {=bool:?}, lfoscgood: {=bool:?}, hsclksoff: {=bool:?}, hfclkoff: {=bool:?}, sysplloff: {=bool:?}, curhsclksel: {:?}, curmclksel: {=bool:?}, hsclkdead: {=bool:?}, hsclkgood: {=bool:?}, lfclkfail: {=bool:?}, fclmode: {=bool:?}, fccdone: {=bool:?}, hfclkblkupd: {=bool:?}, syspllblkupd: {=bool:?}, opampclkerr: {=bool:?}, anaclkerr: {=bool:?} }}" , self . sysoscfreq () , self . hsclkmux () , self . lfclkmux () , self . hfclkgood () , self . syspllgood () , self . lfxtgood () , self . lfoscgood () , self . hsclksoff () , self . hfclkoff () , self . sysplloff () , self . curhsclksel () , self . curmclksel () , self . hsclkdead () , self . hsclkgood () , self . lfclkfail () , self . fclmode () , self . fccdone () , self . hfclkblkupd () , self . syspllblkupd () , self . opampclkerr () , self . anaclkerr ())
        }
    }
    #[doc = "LFCLK_IN and LFCLK control."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Sysstatus {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Sysstatus {{ flashded: {=bool:?}, flashsec: {=bool:?}, borcurthreshold: {:?}, borlvl: {=bool:?}, anacpumpgood: {=bool:?}, pmuirefgood: {=bool:?}, mcan0ready: {=bool:?}, extrstpindis: {=bool:?}, swdcfgdis: {=bool:?}, shdniolock: {=bool:?}, rebootattempts: {=u8:?} }}" , self . flashded () , self . flashsec () , self . borcurthreshold () , self . borlvl () , self . anacpumpgood () , self . pmuirefgood () , self . mcan0ready () , self . extrstpindis () , self . swdcfgdis () , self . shdniolock () , self . rebootattempts ())
        }
    }
    #[doc = "Clear sticky bits of SYSSTATUS."]
    #[repr(transparent)]
