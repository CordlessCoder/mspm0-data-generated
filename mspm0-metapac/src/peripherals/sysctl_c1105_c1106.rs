...
impl Sysctl {
    ...
    #[doc = "High Speed Clock Source Selection."]
    #[inline(always)]
    ...
    #[doc = "LFXT Control -- Only BOR Level Reset will clear."]
    #[inline(always)]
...
pub mod regs {
    ...
    impl Clkstatus {
        ...
        #[doc = "The continuous LFCLK monitor detected a stuck fault."]
        #[must_use]
        #[inline(always)]
    ...
    impl Genclkcfg {
        ...
        #[doc = "Select between the system LFCLK and the external LFCLK for the FCC."]
        #[must_use]
        #[inline(always)]
    ...
    impl Hfclkclkcfg {
        ...
        #[doc = "HFXT range select, which must match the crystal's frequency."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Enables the HFCLK startup monitor."]
        #[must_use]
        #[inline(always)]
    ...
    impl Lfclkcfg {
        ...
        #[doc = "Enables LFXT low capacitance mode, for a load capacitance under 3pF."]
        #[must_use]
        #[inline(always)]
    ...
    impl Lfxtctl {
        #[doc = "Set to start the low frequency crystal oscillator. Remains set until the next BOR level reset."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "Set to switch LFCLK to LFXT. Once set, SETUSELFXT remains set until the next BOR level reset."]
        #[must_use]
        #[inline(always)]
    ...
    impl Nmi {
        ...
        #[doc = "LFXT or EXLF monitor fault."]
        #[must_use]
        #[inline(always)]
        pub const fn lfclkfail(&self) -> bool {
            let val = (self.0 >> 2usize) & 0x01;
...
pub mod vals {
    ...
    pub enum Hfxtrsel {
        #[doc = "4MHz to 8MHz."]
        Range4to8 = 0x0,
        #[doc = "Above 8MHz to 16MHz."]
        Range8to16 = 0x01,
        #[doc = "Above 16MHz to 32MHz."]
        Range16to32 = 0x02,
        #[doc = "Above 32MHz to 48MHz."]
        Range32to48 = 0x03,
    }
    impl Hfxtrsel {
        #[inline(always)]
