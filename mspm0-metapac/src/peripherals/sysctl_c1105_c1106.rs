...
impl Sysctl {
    ...
    ///High Speed Clock Source Selection.
    #[inline(always)]
...
pub mod regs {
    ...
    impl Clkstatus {
        ...
        ///Current HSCLK source, matching HSCLKCFG.HSCLKSEL.
        #[must_use]
        #[inline(always)]
        ...
        ///The HSCLK source did not start correctly.
        #[must_use]
        #[inline(always)]
        ...
        ///The HSCLK source started correctly.
        #[must_use]
        #[inline(always)]
        ...
        ///The continuous LFCLK monitor detected a stuck fault.
        #[must_use]
        #[inline(always)]
    ...
    impl Genclkcfg {
        ...
        ///Divider applied to HFCLK when HFCLK is used as the MFPCLK source.
        #[must_use]
        #[inline(always)]
        ...
        ///Select between the system LFCLK and the external LFCLK for the FCC.
        #[must_use]
        #[inline(always)]
    ...
    impl Hfclkclkcfg {
        ...
        ///HFXT range select, which must match the crystal's frequency.
        #[must_use]
        #[inline(always)]
        ...
        ///Enables the HFCLK startup monitor.
        #[must_use]
        #[inline(always)]
    ...
    impl Lfclkcfg {
        ...
        ///Enables LFXT low capacitance mode, for a load capacitance under 3pF.
        #[must_use]
        #[inline(always)]
    ...
    impl Lfxtctl {
        ///Set to start the low frequency crystal oscillator. Remains set until the next BOR level reset.
        #[must_use]
        #[inline(always)]
        ...
        ///Set to switch LFCLK to LFXT. Once set, SETUSELFXT remains set until the next BOR level reset.
        #[must_use]
        #[inline(always)]
        ...
        #[must_use]
        #[inline(always)]
        pub const fn key(&self) -> super::vals::LfxtctlKey {
            let val = (self.0 >> 24usize) & 0xff;
            super::vals::LfxtctlKey::from_bits(val as u8)
        }
        #[inline(always)]
        pub const fn set_key(&mut self, val: super::vals::LfxtctlKey) {
            self.0 = (self.0 & !(0xff << 24usize))
                | (((val.to_bits() as u32) & 0xff) << 24usize);
        }
    }
    ...
    impl defmt::Format for Lfxtctl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Lfxtctl {{ startlfxt: {=bool:?}, setuselfxt: {=bool:?}, key: {:?} }}",
                self.startlfxt(), self.setuselfxt(), self.key()
            )
        }
    }
    ///Configuration related to MCLK.
    ...
    impl Sysstatus {
        ///Indicates the active brown-out reset supply monitor configuration.
        #[must_use]
        #[inline(always)]
...
pub mod vals {
    ...
    pub enum Hfxtrsel {
        ...
        ///Above 8MHz to 16MHz.
        Range8to16 = 0x01,
        ///Above 16MHz to 32MHz.
        Range16to32 = 0x02,
        ///Above 32MHz to 48MHz.
        Range32to48 = 0x03,
    }
    impl Hfxtrsel {
        #[inline(always)]
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
    pub struct LfxtctlKey(u8);
    impl LfxtctlKey {
        pub const Key: Self = Self(0x91);
    }
    impl LfxtctlKey {
        pub const fn from_bits(val: u8) -> LfxtctlKey {
            Self(val & 0xff)
        }
        pub const fn to_bits(self) -> u8 {
            self.0
    ...
    impl core::fmt::Debug for LfxtctlKey {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            match self.0 {
    ...
    #[cfg(feature = "defmt")]
    impl defmt::Format for LfxtctlKey {
        fn format(&self, f: defmt::Formatter) {
            match self.0 {
    ...
    impl From<u8> for LfxtctlKey {
        #[inline(always)]
        fn from(val: u8) -> LfxtctlKey {
            LfxtctlKey::from_bits(val)
        }
    }
    impl From<LfxtctlKey> for u8 {
        #[inline(always)]
        fn from(val: LfxtctlKey) -> u8 {
            LfxtctlKey::to_bits(val)
        }
    }
    #[repr(u8)]
    #[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
