...
impl Crc {
    ...
    ///CRC polynomial. Bit positions above the configured POLYSIZE are ignored.
    #[inline(always)]
    pub const fn poly(self) -> crate::common::Reg<u32, crate::common::RW> {
...
pub mod regs {
    ...
    impl defmt::Format for Ctrl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Ctrl {{ polysize: {:?}, bitreverse: {=bool:?}, input_endianness: {:?}, output_byteswap: {=bool:?} }}",
                self.polysize(), self.bitreverse(), self.input_endianness(), self
                .output_byteswap()
            )
        }
    }
...
pub mod vals {
    ...
    #[cfg_attr(feature = "defmt", derive(defmt::Format))]
    pub enum Polysize {
        ///CRC-32 ISO-3309 calulation is performed.
        Crc32 = 0x0,
        ///CRC-16 CCITT is performed.
        Crc16 = 0x01,
    }
    impl Polysize {
        #[inline(always)]
