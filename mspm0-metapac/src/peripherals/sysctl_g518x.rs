...
impl Sysctl {
    ...
    ///USB FLL control.
    #[inline(always)]
    pub const fn usbfllctl(
        self,
    ) -> crate::common::Reg<regs::Usbfllctl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x1340usize) as _) }
    }
    ///USB FLL manual adjustment.
    #[inline(always)]
    pub const fn usbflladj(
        self,
    ) -> crate::common::Reg<regs::Usbflladj, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x1344usize) as _) }
    }
    ///USB FLL status.
    #[inline(always)]
    pub const fn usbfllstat(
        self,
    ) -> crate::common::Reg<regs::Usbfllstat, crate::common::R> {
    ...
    pub const fn frxprotmainstart(
        self,
    ) -> crate::common::Reg<regs::Fprotaddr, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn flbankswp(
        self,
    ) -> crate::common::Reg<regs::Flbankswp, crate::common::W> {
    ...
    #[inline(always)]
    pub const fn secstatus(
        self,
    ) -> crate::common::Reg<regs::Secstatus, crate::common::R> {
...
pub mod regs {
    ...
    impl defmt::Format for Clkstatus {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Clkstatus {{ sysoscfreq: {:?}, hsclkmux: {:?}, lfclkmux: {:?}, hfclkgood: {=bool:?}, syspllgood: {=bool:?}, lfxtgood: {=bool:?}, lfoscgood: {=bool:?}, hsclksoff: {=bool:?}, hfclkoff: {=bool:?}, sysplloff: {=bool:?}, curhsclksel: {:?}, curmclksel: {=bool:?}, hsclkdead: {=bool:?}, hsclkgood: {=bool:?}, lfclkfail: {=bool:?}, fclmode: {=bool:?}, fccdone: {=bool:?}, hfclkblkupd: {=bool:?}, syspllblkupd: {=bool:?}, anaclkerr: {=bool:?} }}",
                ...
                self.fccdone(), self.hfclkblkupd(), self.syspllblkupd(), self.anaclkerr()
            )
        }
    }
    ///LFCLK_IN and LFCLK control.
    ...
    impl Flbankswp {
        ...
        ///1: Use Upper Bank as Logical 0.
        #[inline(always)]
        pub const fn set_useupper(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
    }
    ...
    impl core::fmt::Debug for Flbankswp {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Flbankswp").field("useupper", &self.useupper()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Flbankswp {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Flbankswp {{ useupper: {=bool:?} }}", self.useupper())
        }
    }
    ///Flash Bank Swap Policy.
    #[repr(transparent)]
    ...
    impl Flbankswppolicy {
        ///1: Disables Policy To Allow Flash Bank Swapping.
        #[must_use]
        #[inline(always)]
        pub const fn disable(&self) -> bool {
            let val = (self.0 >> 0usize) & 0x01;
    ...
    impl core::fmt::Debug for Flbankswppolicy {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Flbankswppolicy").field("disable", &self.disable()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Flbankswppolicy {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Flbankswppolicy {{ disable: {=bool:?} }}", self.disable())
        }
    }
    ///A flash protection boundary address.
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct Fprotaddr(pub u32);
    impl Fprotaddr {
        ///The boundary address, at 64 byte granularity.
        #[must_use]
        #[inline(always)]
        ...
        pub const fn set_addr(&mut self, val: u16) {
            self.0 = (self.0 & !(0xffff << 6usize))
                | (((val as u32) & 0xffff) << 6usize);
        }
    }
    ...
    impl core::fmt::Debug for Fprotaddr {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Fprotaddr").field("addr", &self.addr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    ...
    impl Fwenable {
        ///1: Flash Read Execute Protection Active.
        #[must_use]
        #[inline(always)]
        ...
        ///1: Flash Read Execute Protection Active.
        #[inline(always)]
        pub const fn set_flrxprot(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
        }
        ///1: Flash Read IP ProtectionActive.
        #[must_use]
        #[inline(always)]
        ...
        ///1: Flash Read IP ProtectionActive.
        #[inline(always)]
        pub const fn set_flipprot(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 6usize)) | (((val as u32) & 0x01) << 6usize);
        }
        ///1: Blocks Writes from Changing SRAMBOUNDARY MMR.
        #[must_use]
        #[inline(always)]
        ...
        ///1: Blocks Writes from Changing SRAMBOUNDARY MMR.
        #[inline(always)]
        pub const fn set_sramboundarylock(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
    }
    ...
    impl core::fmt::Debug for Fwenable {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Fwenable")
                .field("flrxprot", &self.flrxprot())
                .field("flipprot", &self.flipprot())
                .field("sramboundarylock", &self.sramboundarylock())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Fwenable {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Fwenable {{ flrxprot: {=bool:?}, flipprot: {=bool:?}, sramboundarylock: {=bool:?} }}",
                self.flrxprot(), self.flipprot(), self.sramboundarylock()
            )
        }
    }
    ///Read-Write Protection for first 4 Sectors of Data Bank.
    ...
    impl Fwprotmaindata {
        ///00: Both RW allowed 01: Read Only 10: No Read No Write 11: No Read No Write - Not Used.
        #[must_use]
        #[inline(always)]
    ...
    impl core::fmt::Debug for Fwprotmaindata {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Fwprotmaindata").field("data", &self.data()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Fwprotmaindata {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Fwprotmaindata {{ data: {=u8:?} }}", self.data())
        }
    }
    ///General clock configuration.
    #[repr(transparent)]
    ...
    impl Genclkcfg {
        ...
        ///USBCLKSRC selects the USBCLK source.
        #[must_use]
        #[inline(always)]
        pub const fn usbclksrc(&self) -> super::vals::Usbclksrc {
            let val = (self.0 >> 10usize) & 0x01;
            super::vals::Usbclksrc::from_bits(val as u8)
        }
        ///USBCLKSRC selects the USBCLK source.
        #[inline(always)]
        pub const fn set_usbclksrc(&mut self, val: super::vals::Usbclksrc) {
        ...
        ///FCCLFCLKSRC selects between the system LFCLK and an externally sourced LFCLK.
        #[must_use]
        #[inline(always)]
    ...
    impl core::fmt::Debug for Genclkcfg {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Genclkcfg")
                ...
                .field("usbclksrc", &self.usbclksrc())
    ...
    impl defmt::Format for Genclkcfg {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Genclkcfg {{ exclksrc: {:?}, exclkdivval: {:?}, exclkdiven: {=bool:?}, mfpclksrc: {:?}, usbclksrc: {:?}, hfclk4mfpclkdiv: {:?}, fccselclk: {:?}, fcctrigsrc: {:?}, fcclvltrig: {:?}, anacpumpcfg: {:?}, fcctrigcnt: {=u8:?}, fcclfclksrc: {=bool:?} }}",
                self.exclksrc(), self.exclkdivval(), self.exclkdiven(), self.mfpclksrc(),
                self.usbclksrc(), self.hfclk4mfpclkdiv(), self.fccselclk(), self
    ...
    impl Hsclkcfg {
        ...
        ///USBFLL4HSCLK selects the USBFLL as the HSCLK source, overriding HSCLKSEL.
        #[must_use]
        #[inline(always)]
        pub const fn usbfll4hsclk(&self) -> super::vals::Usbfll4hsclk {
            let val = (self.0 >> 1usize) & 0x01;
            super::vals::Usbfll4hsclk::from_bits(val as u8)
        }
        ///USBFLL4HSCLK selects the USBFLL as the HSCLK source, overriding HSCLKSEL.
        #[inline(always)]
        pub const fn set_usbfll4hsclk(&mut self, val: super::vals::Usbfll4hsclk) {
    ...
    impl core::fmt::Debug for Hsclkcfg {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Hsclkcfg")
                ...
                .field("usbfll4hsclk", &self.usbfll4hsclk())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Hsclkcfg {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f, "Hsclkcfg {{ hsclksel: {:?}, usbfll4hsclk: {:?} }}", self.hsclksel(),
                self.usbfll4hsclk()
            )
        }
    }
    ...
    impl Initdone {
        ///INITCODE writes 1 for PASS, left unwritten a timeout will occur if not blocked.
        #[must_use]
        #[inline(always)]
    ...
    impl core::fmt::Debug for Initdone {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Initdone").field("pass", &self.pass()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Initdone {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Initdone {{ pass: {=bool:?} }}", self.pass())
        }
    }
    ///SYSCTL interrupt clear.
    #[repr(transparent)]
    ...
    impl Int {
        ...
        #[must_use]
        #[inline(always)]
        pub const fn usbfllerr(&self) -> bool {
            let val = (self.0 >> 8usize) & 0x01;
            val != 0
        }
        ///USB FLL error.
        #[inline(always)]
        pub const fn set_usbfllerr(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
    }
    ...
    impl core::fmt::Debug for Int {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Int")
                ...
                .field("syspllgood", &self.syspllgood())
                .field("hsclkgood", &self.hsclkgood())
                .field("usbfllerr", &self.usbfllerr())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Int {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Int {{ lfoscgood: {=bool:?}, anaclkerr: {=bool:?}, flashsec: {=bool:?}, sramsec: {=bool:?}, lfxtgood: {=bool:?}, hfclkgood: {=bool:?}, syspllgood: {=bool:?}, hsclkgood: {=bool:?}, usbfllerr: {=bool:?} }}",
                self.lfoscgood(), self.anaclkerr(), self.flashsec(), self.sramsec(), self
                .lfxtgood(), self.hfclkgood(), self.syspllgood(), self.hsclkgood(), self
                .usbfllerr()
            )
        }
    }
    ...
    impl Secstatus {
        ...
        ///1: CSC has been completed.
        #[inline(always)]
        pub const fn set_initdone(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
        }
        ///1: CSC Exists in the system.
        #[must_use]
        #[inline(always)]
        ...
        ///1: CSC Exists in the system.
        #[inline(always)]
        pub const fn set_cscexists(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
        }
        ///1: Flash Read Execute Protection Active.
        #[must_use]
        ...
        ///1: Upper and Lower Banks allowed to be swapped.
        #[must_use]
        #[inline(always)]
        ...
        ///1: Upper and Lower Banks allowed to be swapped.
        #[inline(always)]
        pub const fn set_flbankswppolicy(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 10usize)) | (((val as u32) & 0x01) << 10usize);
        }
        ///1: Upper and Lower Banks have been swapped.
        #[must_use]
        #[inline(always)]
        ...
        ///1: Upper and Lower Banks have been swapped.
        #[inline(always)]
        pub const fn set_flbankswp(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 12usize)) | (((val as u32) & 0x01) << 12usize);
        }
    }
    ...
    impl core::fmt::Debug for Secstatus {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Secstatus")
                .field("initdone", &self.initdone())
                .field("cscexists", &self.cscexists())
                .field("flrxprot", &self.flrxprot())
                .field("flipprot", &self.flipprot())
                .field("sramboundarylock", &self.sramboundarylock())
                .field("flbankswppolicy", &self.flbankswppolicy())
                .field("flbankswp", &self.flbankswp())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Secstatus {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Secstatus {{ initdone: {=bool:?}, cscexists: {=bool:?}, flrxprot: {=bool:?}, flipprot: {=bool:?}, sramboundarylock: {=bool:?}, flbankswppolicy: {=bool:?}, flbankswp: {=bool:?} }}",
                self.initdone(), self.cscexists(), self.flrxprot(), self.flipprot(), self
                .sramboundarylock(), self.flbankswppolicy(), self.flbankswp()
            )
        }
    }
    ///SHUTDOWN IO release control.
    ...
    impl Sysstatus {
        ...
        ///NPUREADY indicates when the NPU is ready.
        #[must_use]
        #[inline(always)]
        pub const fn npuready(&self) -> bool {
            let val = (self.0 >> 24usize) & 0x01;
            val != 0
        }
        ///NPUREADY indicates when the NPU is ready.
        #[inline(always)]
        pub const fn set_npuready(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 24usize)) | (((val as u32) & 0x01) << 24usize);
        }
        ///USBFS0READY indicates when the USBFS0 peripheral is ready.
        #[must_use]
        #[inline(always)]
        pub const fn usbfs0ready(&self) -> bool {
            let val = (self.0 >> 25usize) & 0x01;
            val != 0
        }
        ///USBFS0READY indicates when the USBFS0 peripheral is ready.
        #[inline(always)]
        pub const fn set_usbfs0ready(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 25usize)) | (((val as u32) & 0x01) << 25usize);
        }
    ...
    impl core::fmt::Debug for Sysstatus {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Sysstatus")
                ...
                .field("npuready", &self.npuready())
                .field("usbfs0ready", &self.usbfs0ready())
    ...
    impl defmt::Format for Sysstatus {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Sysstatus {{ flashded: {=bool:?}, flashsec: {=bool:?}, borcurthreshold: {:?}, borlvl: {=bool:?}, anacpumpgood: {=bool:?}, pmuirefgood: {=bool:?}, extrstpindis: {=bool:?}, swdcfgdis: {=bool:?}, shdniolock: {=bool:?}, npuready: {=bool:?}, usbfs0ready: {=bool:?}, rebootattempts: {=u8:?} }}",
                self.flashded(), self.flashsec(), self.borcurthreshold(), self.borlvl(),
                self.anacpumpgood(), self.pmuirefgood(), self.extrstpindis(), self
                .swdcfgdis(), self.shdniolock(), self.npuready(), self.usbfs0ready(),
                self.rebootattempts()
            )
        }
    }
    ...
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct Usbflladj(pub u32);
    impl Usbflladj {
        ///Frequency lock loop adjust.
        #[must_use]
        #[inline(always)]
        pub const fn frqadj(&self) -> u8 {
            let val = (self.0 >> 0usize) & 0x3f;
            val as u8
        }
        ///Frequency lock loop adjust.
        #[inline(always)]
        pub const fn set_frqadj(&mut self, val: u8) {
            self.0 = (self.0 & !(0x3f << 0usize)) | (((val as u32) & 0x3f) << 0usize);
        }
        ///Frequency lock loop modulator value.
        #[must_use]
        #[inline(always)]
        pub const fn frqmod(&self) -> u8 {
            let val = (self.0 >> 8usize) & 0x07;
            val as u8
        }
        ///Frequency lock loop modulator value.
        #[inline(always)]
        pub const fn set_frqmod(&mut self, val: u8) {
            self.0 = (self.0 & !(0x07 << 8usize)) | (((val as u32) & 0x07) << 8usize);
        }
    }
    impl Default for Usbflladj {
        #[inline(always)]
        fn default() -> Usbflladj {
            Usbflladj(0)
        }
    }
    impl core::fmt::Debug for Usbflladj {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Usbflladj")
                .field("frqadj", &self.frqadj())
                .field("frqmod", &self.frqmod())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Usbflladj {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f, "Usbflladj {{ frqadj: {=u8:?}, frqmod: {=u8:?} }}", self.frqadj(),
                self.frqmod()
            )
        }
    }
    ...
    impl Usbfllctl {
        ...
        ///USB oscillator frequency lock loop enable.
        #[must_use]
        #[inline(always)]
        ...
        ///Reference clock selection for the frequency lock loop.
        #[must_use]
        #[inline(always)]
    ...
    impl Default for Usbfllctl {
        #[inline(always)]
        fn default() -> Usbfllctl {
            Usbfllctl(0)
        }
    }
    impl core::fmt::Debug for Usbfllctl {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Usbfllctl")
    ...
    #[cfg(feature = "defmt")]
    impl defmt::Format for Usbfllctl {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f, "Usbfllctl {{ clken: {=bool:?}, fllen: {=bool:?}, refsel: {:?} }}",
                self.clken(), self.fllen(), self.refsel()
            )
        }
    }
    ///USB FLL status.
    #[repr(transparent)]
    #[derive(Copy, Clone, Eq, PartialEq)]
    pub struct Usbfllstat(pub u32);
    impl Usbfllstat {
        ///USB oscillator ready indication.
        #[must_use]
        #[inline(always)]
        ...
        ///USB oscillator frequency lock loop lock indication.
        #[must_use]
        #[inline(always)]
        pub const fn flllock(&self) -> bool {
            let val = (self.0 >> 1usize) & 0x01;
            val != 0
        }
        ///USB oscillator frequency lock loop lock indication.
        #[inline(always)]
        pub const fn set_flllock(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        ///Reference clock for the frequency lock loop ready indication.
        #[must_use]
        #[inline(always)]
        pub const fn refrdy(&self) -> bool {
            let val = (self.0 >> 8usize) & 0x01;
            val != 0
        }
        ///Reference clock for the frequency lock loop ready indication.
        #[inline(always)]
        pub const fn set_refrdy(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 8usize)) | (((val as u32) & 0x01) << 8usize);
        }
        ///Current frequency lock loop adjust.
        #[must_use]
        #[inline(always)]
        pub const fn frqadj(&self) -> u8 {
            let val = (self.0 >> 16usize) & 0x3f;
        ...
        ///Current frequency lock loop modulator value.
        #[must_use]
        #[inline(always)]
        pub const fn frqmod(&self) -> u8 {
    ...
    impl Default for Usbfllstat {
        #[inline(always)]
        fn default() -> Usbfllstat {
            Usbfllstat(0)
        }
    }
    impl core::fmt::Debug for Usbfllstat {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Usbfllstat")
                .field("clkrdy", &self.clkrdy())
                .field("flllock", &self.flllock())
                .field("refrdy", &self.refrdy())
                .field("frqadj", &self.frqadj())
                .field("frqmod", &self.frqmod())
                .finish()
        }
    ...
    #[cfg(feature = "defmt")]
    impl defmt::Format for Usbfllstat {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Usbfllstat {{ clkrdy: {=bool:?}, flllock: {=bool:?}, refrdy: {=bool:?}, frqadj: {=u8:?}, frqmod: {=u8:?} }}",
                self.clkrdy(), self.flllock(), self.refrdy(), self.frqadj(), self
                .frqmod()
            )
        }
    }
...
pub mod vals {
    ...
    pub enum Exclksrc {
        ...
        Syspllout1 = 0x05,
        ///CLK_OUT is USBFLL (at 60MHz it must be divided for external output).
        Usbfll = 0x06,
        _RESERVED_7 = 0x07,
    }
    impl Exclksrc {
    ...
    #[cfg_attr(feature = "defmt", derive(defmt::Format))]
    pub enum Refsel {
        ///Use the USB start-of-frame as the reference clock.
        Usbsof = 0x0,
        ///Use LFCLK as the reference clock.
        Lfclk = 0x01,
    }
    impl Refsel {
        #[inline(always)]
    ...
    #[cfg_attr(feature = "defmt", derive(defmt::Format))]
    pub enum Usbclksrc {
        ///USBCLK source is USBFLL.
        Usbfllclk = 0x0,
        ///USBCLK source is SYSPLLCLK1.
        Syspllout1 = 0x01,
    }
    impl Usbclksrc {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Usbclksrc {
            unsafe { core::mem::transmute(val & 0x01) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Usbclksrc {
        #[inline(always)]
        fn from(val: u8) -> Usbclksrc {
            Usbclksrc::from_bits(val)
        }
    }
    impl From<Usbclksrc> for u8 {
        #[inline(always)]
        fn from(val: Usbclksrc) -> u8 {
            Usbclksrc::to_bits(val)
        }
    }
    #[repr(u8)]
    #[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
    #[cfg_attr(feature = "defmt", derive(defmt::Format))]
    pub enum Usbfll4hsclk {
        ///HSCLK is sourced from HSCLKCFG.HSCLKSEL.
        SyspllHfclk = 0x0,
        ///HSCLK is sourced from the USBFLL.
        Usbfll = 0x01,
    }
    impl Usbfll4hsclk {
        #[inline(always)]
        pub const fn from_bits(val: u8) -> Usbfll4hsclk {
            unsafe { core::mem::transmute(val & 0x01) }
        }
        #[inline(always)]
        pub const fn to_bits(self) -> u8 {
    ...
    impl From<u8> for Usbfll4hsclk {
        #[inline(always)]
        fn from(val: u8) -> Usbfll4hsclk {
            Usbfll4hsclk::from_bits(val)
        }
    }
    impl From<Usbfll4hsclk> for u8 {
        #[inline(always)]
        fn from(val: Usbfll4hsclk) -> u8 {
            Usbfll4hsclk::to_bits(val)
        }
    }
    #[repr(u8)]
    #[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
