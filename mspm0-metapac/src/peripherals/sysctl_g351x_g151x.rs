...
pub mod regs {
    ...
    impl core::fmt::Debug for Sramboundaryhigh {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Sramboundaryhigh").field("addr", &self.addr()).finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Sramboundaryhigh {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Sramboundaryhigh {{ addr: {=u16:?} }}", self.addr())
        }
    }
    ///System SRAM configuration.
    #[repr(transparent)]
    ...
    impl Sramcfg {
        ///SRAM BANK1 power level for RUN mode.
        #[must_use]
        #[inline(always)]
        ...
        ///SRAM BANK1 power level for RUN mode.
        #[inline(always)]
        pub const fn set_bankoff1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
        }
        ///SRAM BANK1 power level for STOP mode.
        #[must_use]
        #[inline(always)]
        ...
        ///SRAM BANK1 power level for STOP mode.
        #[inline(always)]
        pub const fn set_bankstop1(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
        }
    }
    ...
    impl core::fmt::Debug for Sramcfg {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Sramcfg")
                .field("bankoff1", &self.bankoff1())
                .field("bankstop1", &self.bankstop1())
                .finish()
        }
    }
    #[cfg(feature = "defmt")]
    impl defmt::Format for Sramcfg {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f, "Sramcfg {{ bankoff1: {=bool:?}, bankstop1: {=bool:?} }}", self
                .bankoff1(), self.bankstop1()
            )
        }
    }
    ///Disable the SWD function on the SWD pins.
    ...
    impl Sysstatus {
        ...
        ///MCAN1READY indicates when the MCAN1 peripheral is ready.
        #[must_use]
        #[inline(always)]
        ...
        ///MCAN1READY indicates when the MCAN1 peripheral is ready.
        #[inline(always)]
        pub const fn set_mcan1ready(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 9usize)) | (((val as u32) & 0x01) << 9usize);
        }
        ...
        ///SRAM BANK1 READY STATE.
        #[inline(always)]
        pub const fn set_srambank1ready(&mut self, val: bool) {
            self.0 = (self.0 & !(0x01 << 17usize)) | (((val as u32) & 0x01) << 17usize);
        }
    ...
    impl defmt::Format for Sysstatus {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Sysstatus {{ flashded: {=bool:?}, flashsec: {=bool:?}, borcurthreshold: {:?}, borlvl: {=bool:?}, anacpumpgood: {=bool:?}, pmuirefgood: {=bool:?}, mcan0ready: {=bool:?}, mcan1ready: {=bool:?}, extrstpindis: {=bool:?}, swdcfgdis: {=bool:?}, shdniolock: {=bool:?}, srambank1ready: {=bool:?}, rebootattempts: {=u8:?} }}",
                self.flashded(), self.flashsec(), self.borcurthreshold(), self.borlvl(),
                self.anacpumpgood(), self.pmuirefgood(), self.mcan0ready(), self
                .mcan1ready(), self.extrstpindis(), self.swdcfgdis(), self.shdniolock(),
                self.srambank1ready(), self.rebootattempts()
            )
        }
    }
    ///Clear sticky bits of SYSSTATUS.
